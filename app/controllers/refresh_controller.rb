class RefreshController < ApplicationController
  ...
  def flickr_search
    ...
    require 'xmlsimple'
    url = "http://www.flickr.com/services/rest/?method=flickr.photos.search&format=rest&api_key=739e578b0095d2ce5978331ac7466bd4&tags=#{tags}&per_page=#{per_page}0&extras=url_o,url_s,url_m"
